...
struct ParamSet {
	...
	ParamSet() : depthSigma(1.6e-6),
		stdTol_init(1), stdTol_merge(0.1),
		z_near(750), z_far(4000),
		angle_near(MACRO_DEG2RAD(10.0)), angle_far(MACRO_DEG2RAD(90.0)),
		similarityTh_merge(std::cos(MACRO_DEG2RAD(120.0))),
		similarityTh_refine(std::cos(MACRO_DEG2RAD(30.0))),
		depthAlpha(0.04), depthChangeTol(0.001),
